...
Public Class ReportNasabah
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aiafinancial.ReportNasabah.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportNasabah
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportNasabah = New ReportNasabah
        rpt.Site = Me.Site
        Return rpt
    End Function
