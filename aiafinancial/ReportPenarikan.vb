...
Public Class ReportPenarikan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aiafinancial.ReportPenarikan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportPenarikan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportPenarikan = New ReportPenarikan
        rpt.Site = Me.Site
        Return rpt
    End Function
