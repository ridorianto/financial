...
Public Class ReportSetoran
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aiafinancial.ReportSetoran.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportSetoran
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportSetoran = New ReportSetoran
        rpt.Site = Me.Site
        Return rpt
    End Function
