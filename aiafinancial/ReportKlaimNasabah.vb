...
Public Class ReportKlaimNasabah
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aiafinancial.ReportKlaimNasabah.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportKlaimNasabah
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportKlaimNasabah = New ReportKlaimNasabah
        rpt.Site = Me.Site
        Return rpt
    End Function
